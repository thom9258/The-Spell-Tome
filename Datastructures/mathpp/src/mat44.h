...
void mat44_rsetrow(Mat44* a, int row, float v1, float v2, float v3, float v4);
void mat44_rsetcol(Mat44* a, int col, float v1, float v2, float v3, float v4);
...
void
mat44_rsetrow(Mat44* a, int row, float v1, float v2, float v3, float v4)
{
    a->m[row][0] = v1;
    a->m[row][1] = v2;
    a->m[row][2] = v3;
...
void
mat44_rsetcol(Mat44* a, int col, float v1, float v2, float v3, float v4)
{
    a->m[0][col] = v1;
    a->m[1][col] = v2;
    a->m[2][col] = v3;
