...
A setup for testing the defined function "int plus(int a, int b)"
...
#define TL_FUNCTIONSTRING(FN) (char*)#FN
...
void
_TL_TEST_FUNCTION(char _expr, char* _expr_str, int _line, char* _msg)
/**
...
void
_TL_PRE_FUNCTION(char* _file_name, char* _test_name, char* _test_message)
/**
...
void
_TL_POST_FUNCTION(char* _test_name)
/**
 ...
 */
{
	...
	char* outcome = NULL;
	test_names[tests_encountered] = _test_name;
